...
const MCQQuiz = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {/* {quizComplete && (
        <div className="bg-white/50 backdrop-blur-sm rounded-lg shadow p-6 space-y-4">
          <h2 className="text-xl font-semibold text-[#8b5e34]">Recent Quiz</h2>
          <div className="bg-white/80 p-4 rounded-lg border border-[#e6c199]">
            <div className="text-lg font-medium text-[#8b5e34]">
              Score: {score}/{questions.length}
            </div>
            <Button
              onClick={startNewQuiz}
              className="mt-4 bg-[#e6c199] text-[#8b5e34] hover:bg-[#d4b089]"
            >
              Try Another Topic
            </Button>
          </div>
